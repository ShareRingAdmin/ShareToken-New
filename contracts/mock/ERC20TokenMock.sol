...
contract ERC20TokenMock is IERC20 {
    ...
    function balanceOf(address _owner) public override virtual view returns (uint256) {
    ...
    function transfer(address _to, uint256 _amount) public override virtual returns (bool) {
    ...
    function transferFrom(address _from, address _to, uint256 _amount) public override virtual returns (bool) {
